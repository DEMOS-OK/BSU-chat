    ...
    >
        ...
        >
            <Link
                ...
                class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-blur-500"
            >
                Dashboard
            </Link>
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <ApplicationMark class="w-1/4 h-1/4"></ApplicationMark>
            </div>
                ...
                >
                    <div class="flex items-center gap-4">
                        <a
                            ...
                            href="https://career.habr.com/demos-ok"
                            target="_blank"
                        >
                            <svg
